...
var args8516 = [];
var len__7664__auto___8519 = arguments.length;
var i__7665__auto___8520 = (0);
while(true){
if((i__7665__auto___8520 < len__7664__auto___8519)){
args8516.push((arguments[i__7665__auto___8520]));

var G__8521 = (i__7665__auto___8520 + (1));
i__7665__auto___8520 = G__8521;
continue;
} else {
}
break;
...
var G__8524 = (((format instanceof cljs.core.Keyword))?format.fqn:null);
switch (G__8524) {
case "transit":
return ajax.transit.transit_request_format.call(null,format_params);
...
var G__8527 = (((format instanceof cljs.core.Keyword))?format.fqn:null);
switch (G__8527) {
case "transit":
...
if(cljs.core.vector_QMARK_.call(null,format)){
return cljs.core.apply.call(null,cljs.core.vector,cljs.core.map.call(null,(function (p1__8529_SHARP_){
return ajax.easy.keyword_response_format_element.call(null,p1__8529_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__8530){
var map__8536 = p__8530;
...
var handler = cljs.core.get.call(null,map__8536__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.call(null,map__8536__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.call(null,map__8536__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
var h = (function (){var or__6594__auto__ = handler;
...
var e = (function (){var or__6594__auto__ = error_handler;
if(cljs.core.truth_(or__6594__auto__)){
return or__6594__auto__;
} else {
...
return ((function (h,e,map__8536,map__8536__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__8538){
var vec__8540 = p__8538;
var ok = cljs.core.nth.call(null,vec__8540,(0),null);
var result = cljs.core.nth.call(null,vec__8540,(1),null);
...
;})(h,e,map__8536,map__8536__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__8541){
var map__8544 = p__8541;
...
var opts = map__8544__$1;
var method = cljs.core.get.call(null,map__8544__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.call(null,map__8544__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.call(null,map__8544__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.call(null,map__8544__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.call(null,map__8544__$1,new cljs.core.Keyword(null,"body","body",-2049205669));

var needs_format = ((body == null)) && (cljs.core.not_EQ_.call(null,method,"GET"));
var rf = (cljs.core.truth_((function (){var or__6594__auto__ = format;
if(cljs.core.truth_(or__6594__auto__)){
return or__6594__auto__;
} else {
return needs_format;
