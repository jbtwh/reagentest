...
var or__6594__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__6594__auto__)){
return or__6594__auto__;
} else {
var or__6594__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__6594__auto____$1)){
return or__6594__auto____$1;
} else {
var or__6594__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__6594__auto____$2)){
return or__6594__auto____$2;
} else {
var or__6594__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__6594__auto____$3)){
return or__6594__auto____$3;
} else {
...
var n__7509__auto__ = a.length;
var i = (0);
while(true){
if((i < n__7509__auto__)){
var c_8747 = (a[i]);
if(cljs.core.truth_((c_8747["cljsIsDirty"]))){
(c_8747["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__7200__auto__,writer__7201__auto__,opt__7202__auto__){
return cljs.core._write.call(null,writer__7201__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__8751 = c;
var G__8751__$1 = (((G__8751 == null))?null:(G__8751["props"]));
if((G__8751__$1 == null)){
return null;
} else {
return (G__8751__$1["argv"]);
}
});
...
var G__8753_8754 = (c["cljsRatom"]);
if((G__8753_8754 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__8753_8754);
}
